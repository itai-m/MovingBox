...
public class PlatformerCharacter2D : MonoBehaviour
{
    ...
    public float timeBeforeDestroyShots = 4F;
    ...
    public void Move(float move, bool lookUp, bool lookDown, bool fire) {
        if (fire) {
            Fire();
        }
        ...
        if (m_Grounded || m_AirControl) {
            ...
            if (move > 0 && !isFaceRight) {
                // ... flip the player.
                Flip();
                return;
            }
            // Otherwise if the input is moving the player left and the player is facing right...
            else if (move < 0 && isFaceRight) {
                // ... flip the player.
                Flip();
                return;
            }
    ...
    public void Move1(float move, bool crouch, bool jump, bool fire)
    {
        if (fire) {
            Fire();
        }
        ...
        if (m_Grounded || m_AirControl)
        {
            ...
            // If the input is moving the player right and the player is facing left...
            if (move > 0 && (direction == Direction.Left))
            {
                // ... flip the player.
                Flip();
            }
                // Otherwise if the input is moving the player left and the player is facing right...
            else if (move < 0 && (direction == Direction.Right))
            {
                // ... flip the player.
                Flip();
            }
